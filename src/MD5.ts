function md5_encode(api_key:string,artist:string,sk:string,track:string,secret:string) {
    ...
    return MD5(`api_key${api_key}artist${artist}methodtrack.unlovesk${sk}track${track}${secret}`);
}

export default md5_encode